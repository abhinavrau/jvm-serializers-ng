...
public final class MediaMinified   implements java.lang.Cloneable, java.io.Serializable, com.dslplatform.json.JsonObject {
	...
	static void __serializeJsonObjectMinimal(final MediaMinified self, com.dslplatform.json.JsonWriter sw, boolean hasWrittenProperty) {
		...
		final java.util.List<String> _tmp_persons_ = self.persons;
		if(_tmp_persons_.size() != 0) {
			if(hasWrittenProperty) sw.writeByte(com.dslplatform.json.JsonWriter.COMMA);
			hasWrittenProperty = true;
			sw.writeAscii("\"p\":[", 5);
			sw.writeString(_tmp_persons_.get(0));
			for(int i = 1; i < _tmp_persons_.size(); i++) {
				sw.writeByte(com.dslplatform.json.JsonWriter.COMMA);
				sw.writeString(_tmp_persons_.get(i));
			}
	...
	public static final com.dslplatform.json.JsonReader.ReadJsonObject<MediaMinified> JSON_READER = new com.dslplatform.json.JsonReader.ReadJsonObject<MediaMinified>() {
		...
		public MediaMinified deserialize(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			return new MediaMinified(reader);
		}
	};
	...
	private MediaMinified(final com.dslplatform.json.JsonReader<Object> reader) throws java.io.IOException {
		...
		if(nextToken != '}') {
			...
			switch(nameHash) {
					...
					if(nextToken == 'n') {
						if (reader.wasNull()) {
							throw new java.io.IOException("Property format does not allow null. null value detected at position " + reader.positionInStream());
						}
						throw new java.io.IOException("Expecting 'u' (as null) at position " + reader.positionInStream() + ". Found " + (char)nextToken);
					}
					...
					if(nextToken == 'n') {
						if (reader.wasNull()) {
							throw new java.io.IOException("Property duration does not allow null. null value detected at position " + reader.positionInStream());
						}
						throw new java.io.IOException("Expecting 'u' (as null) at position " + reader.positionInStream() + ". Found " + (char)nextToken);
					}
					...
					if(nextToken == 'n') {
						if (reader.wasNull()) {
							throw new java.io.IOException("Property size does not allow null. null value detected at position " + reader.positionInStream());
						}
						throw new java.io.IOException("Expecting 'u' (as null) at position " + reader.positionInStream() + ". Found " + (char)nextToken);
					}
					...
					if(nextToken == 'n') {
						if (reader.wasNull()) {
							throw new java.io.IOException("Property bitrate does not allow null. null value detected at position " + reader.positionInStream());
						}
						throw new java.io.IOException("Expecting 'u' (as null) at position " + reader.positionInStream() + ". Found " + (char)nextToken);
					}
					...
					if(nextToken == 'n') {
						if (reader.wasNull()) {
							throw new java.io.IOException("Property persons does not allow null. null value detected at position " + reader.positionInStream());
						}
						throw new java.io.IOException("Expecting 'u' (as null) at position " + reader.positionInStream() + ". Found " + (char)nextToken);
					}
		...
		if(_player_ == null) _player_ = serializers.dslplatform.shared.Player.JAVA;
