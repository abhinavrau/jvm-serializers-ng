...
/**
 * Driver that uses JSON.simple [http://code.google.com/p/json-simple/], with manual parsing with a
 * ContentHandler.
 */
public class JsonSimpleWithContentHandler {
  ...
  static class SemiManualSerializer extends Serializer<MediaContent> {
    ...
    private static MediaContent readMediaContent(JSONParser parser,
        MediaContentTransformer transformer, String mediaContentJsonInput) throws Exception {
