...
public class JsonijJpath {
  ...
  static class SemiManualSerializer extends Serializer<MediaContent> {
    ...
    static MediaContent readMediaContent(String mediaContentJsonInput) throws Exception {
      ...
      media.duration = JPath.parse("/serializers.media/duration").evaluate(json).getNumber()
          .longValue();
      ...
      JSON.Array<Value> personValues = (JSON.Array<Value>) JPath.parse("/serializers.media/persons")
          .evaluate(json);
      ...
      media.player = Media.Player
          .valueOf(JPath.parse("/serializers.media/player").evaluate(json).getString());
