...
public class JacksonWithAfterburner
{
    ...
    public static void registerJSON(TestGroups groups)
    {
        ...
        groups.media.add(JavaBuiltIn.mediaTransformer,
                new StdJacksonDataBind<MediaContent>("json/serializers.jackson+afterburner/databind", MediaContent.class, mapper),
    ...
    public static void registerCBOR(TestGroups groups)
    {
        ...
        mapper.registerModule(new AfterburnerModule());
        groups.media.add(JavaBuiltIn.mediaTransformer,
                new StdJacksonDataBind<MediaContent>("cbor/serializers.jackson+afterburner/databind", MediaContent.class, mapper),
                new SerFeatures(SerFormat.BINARY, SerGraph.FLAT_TREE, SerClass.ZERO_KNOWLEDGE, STD_DESC));
    }
    ...
    public static void registerSmile(TestGroups groups, boolean shareNames, boolean shareValues)
    {
        ...
        groups.media.add(JavaBuiltIn.mediaTransformer,
                new StdJacksonDataBind<MediaContent>("smile/serializers.jackson+afterburner/databind", MediaContent.class, smileMapper),
                new SerFeatures(SerFormat.BINARY, SerGraph.FLAT_TREE, SerClass.ZERO_KNOWLEDGE, STD_DESC));
    }
}
