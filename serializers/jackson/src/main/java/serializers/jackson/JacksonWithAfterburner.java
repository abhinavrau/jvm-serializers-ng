...
/**
 * Class for registering variants of Jackson-based tests that use Afterburner for generating byte
 * code to avoid use of Reflection for calling methods and constructing objects.
 */
public class JacksonWithAfterburner {
  ...
  public static void registerSmile(MediaContentTestGroup groups, boolean shareNames,
      boolean shareValues) {
