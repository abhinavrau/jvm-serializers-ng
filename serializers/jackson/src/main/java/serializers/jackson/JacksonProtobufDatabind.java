...
public class JacksonProtobufDatabind
{
    public static void register(TestGroups groups) {
        ...
        groups.media.add(JavaBuiltIn.mediaTransformer,
                new StdJacksonDataBind<MediaContent>("protobuf/serializers.jackson/databind", type, mapper,
        ...
        groups.media.add(JavaBuiltIn.mediaTransformer,
                new StdJacksonDataBind<MediaContent>("protobuf/serializers.jackson+afterburner/databind", type, mapper,
                        mapper.readerFor(MediaContent.class).with(schema),
                        mapper.writerFor(MediaContent.class).with(schema)),
                new SerFeatures(
                        SerFormat.BINARY,
