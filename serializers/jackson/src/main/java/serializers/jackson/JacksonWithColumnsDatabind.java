...
public class JacksonWithColumnsDatabind
{
    ...
    public static void registerCBOR(TestGroups groups)
    {
        ...
        groups.media.add(JavaBuiltIn.mediaTransformer,
                new StdJacksonDataBind<MediaContent>("cbor-col/serializers.jackson/databind", MediaContent.class, cborMapper),
    ...
    public static void registerJSON(TestGroups groups)
    {
        ...
        groups.media.add(JavaBuiltIn.mediaTransformer,
                new StdJacksonDataBind<MediaContent>("json-col/serializers.jackson/databind", MediaContent.class, jsonMapper),
                new SerFeatures(SerFormat.JSON,SerGraph.FLAT_TREE,SerClass.ZERO_KNOWLEDGE,STD_DESC));
    }
    ...
    public static void registerSmile(TestGroups groups)
    {
        ...
        groups.media.add(JavaBuiltIn.mediaTransformer,
                new StdJacksonDataBind<MediaContent>("smile-col/serializers.jackson/databind", MediaContent.class, smileMapper),
                new SerFeatures(SerFormat.JSON,SerGraph.FLAT_TREE,SerClass.ZERO_KNOWLEDGE,STD_DESC));
    }
}
