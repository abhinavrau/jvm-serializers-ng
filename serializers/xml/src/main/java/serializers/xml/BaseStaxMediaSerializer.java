...
public abstract class BaseStaxMediaSerializer extends Serializer<MediaContent> {
  ...
  protected BaseStaxMediaSerializer(SerializerProperties properties,
      boolean workingGetElementText) {
    super(properties);
  ...
  @Override
  public MediaContent[] deserializeItems(InputStream in, int numberOfItems)
  ...
  @Override
  public final void serializeItems(MediaContent[] items, OutputStream out)
      throws XMLStreamException {
