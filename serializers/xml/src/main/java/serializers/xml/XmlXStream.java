  ...
  public static void register(MediaContentTestGroup groups) {
    ...
    for (XmlStax.Handler h : XmlStax.HANDLERS) {
      ...
      groups.media.add(JavaBuiltIn.mediaTransformer,
          XmlXStream.<MediaContent>mkStaxSerializer(properties, h, MediaConfiguration));
  ...
  public static class MediaConfiguration extends Configuration {
    ...
    private static class ImageConverter implements Converter {
      ...
      public void marshal(Object obj, HierarchicalStreamWriter writer, MarshallingContext context) {
        ...
        if (image.title != null) {
          writer.addAttribute("title", image.title);
        }
    ...
    private static class MediaConverter implements Converter {
      ...
      public void marshal(Object obj, HierarchicalStreamWriter writer, MarshallingContext context) {
        ...
        if (media.title != null) {
          writer.addAttribute("title", media.title);
        }
        ...
        if (media.hasBitrate) {
          writer.addAttribute("bitrate", String.valueOf(media.bitrate));
        }
        if (media.copyright != null) {
          writer.addAttribute("copyright", media.copyright);
        }
  ...
  public static class MediaConfigurationAbbreviated extends Configuration {
    ...
    private static class ImageConverter implements Converter {
      ...
      public void marshal(Object obj, HierarchicalStreamWriter writer, MarshallingContext context) {
        ...
        if (image.title != null) {
          writer.addAttribute("tl", image.title);
        }
    ...
    private static class MediaConverter implements Converter {
      ...
      public void marshal(Object obj, HierarchicalStreamWriter writer, MarshallingContext context) {
        ...
        if (media.title != null) {
          writer.addAttribute("tl", media.title);
        }
        ...
        if (media.hasBitrate) {
          writer.addAttribute("br", String.valueOf(media.bitrate));
        }
        if (media.copyright != null) {
