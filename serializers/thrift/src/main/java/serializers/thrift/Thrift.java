...
import serializers.thrift.media.Image;
import serializers.thrift.media.Media;
import serializers.thrift.media.MediaContent;
import serializers.thrift.media.Player;
import serializers.thrift.media.Size;
...
public class Thrift {
  ...
  public static void register(MediaContentTestGroup groups) {
    ...
    groups.media
        .add(mediaTransformer, new MediaSerializer(compact_properties, ProtocolSpec.CompactBinary));
  }
  ...
  public static final class ProtocolSpec {
    ...
    public static final ProtocolSpec DefaultBinary = new ProtocolSpec(new TBinaryProtocol.Factory(),
        "");
    public static final ProtocolSpec CompactBinary = new ProtocolSpec(
        new TCompactProtocol.Factory(), "-compact");
  }
