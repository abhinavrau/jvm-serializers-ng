...
import serializers.core.metadata.SerializerProperties.SerializerPropertiesBuilder;

public class AvroGeneric {

  public static void register(MediaContentTestGroup groups) {
    SerializerPropertiesBuilder builder = SerializerProperties.builder();
  ...
  public static final Transformer<MediaContent, GenericRecord> MediaTransformer = new MediaTransformer<GenericRecord>() {
    ...
    public GenericRecord forward(MediaContent mc) {
      ...
      GenericData.Array<GenericRecord> images = new GenericData.Array<>(mc.images.size(),
          Avro.Media.sImages);
    ...
    private GenericRecord forwardMedia(Media media) {
      ...
      GenericData.Array<CharSequence> persons = new GenericData.Array<>(media.persons.size(),
          Avro.Media.sPersons);
    ...
    public GenericEnumSymbol forwardPlayer(Media.Player p) {
      switch (p) {
        case JAVA:
          return new GenericData.EnumSymbol(sPlayer, "JAVA");
        case FLASH:
          return new GenericData.EnumSymbol(sSize, "FLASH");
        default:
    ...
    public GenericEnumSymbol forwardSize(Image.Size s) {
      switch (s) {
        case SMALL:
          return new GenericData.EnumSymbol(sSize, "SMALL");
        case LARGE:
          return new GenericData.EnumSymbol(sSize, "LARGE");
        default:
    ...
    public MediaContent reverse(GenericRecord mc) {
      ...
      GenericData.Array<GenericRecord> gimages = (GenericData.Array<GenericRecord>) mc
          .get("images");
    ...
    private Media reverseMedia(GenericRecord media) {
      ...
      @SuppressWarnings("unchecked")
      GenericData.Array<CharSequence> gpersons = (GenericData.Array<CharSequence>) media
          .get("persons");
    ...
    public MediaContent shallowReverse(GenericRecord mc) {
      return new MediaContent(reverseMedia((GenericRecord) mc.get("media")),
