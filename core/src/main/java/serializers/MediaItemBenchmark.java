...
/**
 * Intermediate base class for tests that use a single <code>MediaItem</code> as data. The only
 * method missing is <code>addTests</code>, which defines codecs to use.
 */
public abstract class MediaItemBenchmark extends BenchmarkBase {
  ...
  @Override
  protected <J> byte[] serializeForSize(Transformer<J, Object> transformer,
  ...
  @Override
  public <J> void checkCorrectness(PrintWriter errors, Transformer<J, Object> transformer,
      Serializer<Object> serializer, J value)
      throws Exception {
  ...
  protected final TestCase Create = new TestCase() {
    public <J> double run(Transformer<J, Object> transformer, Serializer<Object> serializer,
        J value, int iterations) throws Exception {
