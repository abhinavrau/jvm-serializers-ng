...
/**
 * A factory for creating a reflection comparator. This will assemble the apropriate comparator
...
public class ReflectionComparatorFactory {
   ...
   */
  protected static final Comparator OBJECT_COMPARATOR = new IgnoreClassObjectComparator();
   ...
   */
  public static org.unitils.reflectionassert.ReflectionComparator createRefectionComparator(
